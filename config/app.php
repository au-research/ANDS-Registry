...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        ANDS\Providers\AppServiceProvider::class,
        ANDS\Providers\AuthServiceProvider::class,
        ANDS\Providers\EventServiceProvider::class,
        ANDS\Providers\RouteServiceProvider::class,
    ...
    */
    ...
    'aliases' => [
        ...
        'XMLParser' => Nathanmac\Utilities\Parser\Facades\Parser::class
    ],

    'rifcs' => [
        'namespace' => "http://ands.org.au/standards/rif-cs/registryObjects",
        'classes' => [
            'collection', 'service', 'activity', 'party'
        ],
        'providers' => [
